...
class Mage_Newsletter_SubscriberController extends Mage_Core_Controller_Front_Action {
    ...
    public function newAction() {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
                if (!Zend_Validate::is($subscriber_name, 'NotEmpty')) {
                    Mage::throwException($this->__('Please enter the first name.'));
                }
                ...
                // Salva o nome do usuario na base
                ...
                $sql = "UPDATE " . $productWriteTable . " SET subscriber_name='" . $subscriber_name . "' WHERE subscriber_id=$id";
                $write->query($sql);
